...
import {  Users, Award, BookOpen, GraduationCap, Lightbulb, AwardIcon } from 'lucide-react'
            ...
            <div className="flex-1 max-w-2xl">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <div key={index} className="text-center p-3 md:p-4 bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-4">
                <button onClick={()=>navigate('/about')} className="group bg-gradient-to-r from-amber-500 to-orange-600 text-white px-3 py-2 rounded-full font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
