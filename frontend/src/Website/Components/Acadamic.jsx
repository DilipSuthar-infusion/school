       ...
       <section id="programs" className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div class="text-center"><div class="inline-flex items-center text-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-4"><BookOpen className='w-4'/>Milestones We've Reached</div></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2 md:mb-4">Academic Programs</h2>
            <p className="text-sm sm:text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive educational programs designed to nurture students at every stage of their development
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {programs.map((program, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-6 lg:p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-4">{program.title}</h3>
